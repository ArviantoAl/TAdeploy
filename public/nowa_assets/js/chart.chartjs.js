$(function() {
	...
	// 	}
	// });
	// var ctx3 = document.getElementById('chartArea1').getContext('2d');
	...
	// var gradient1 = ctx8.createLinearGradient(0, 350, 0, 0);
	// gradient1.addColorStop(0, 'rgba(254, 78, 140, .0)');
	// gradient1.addColorStop(1, 'rgba(254, 78, 140, .5)');
	// var gradient2 = ctx8.createLinearGradient(0, 280, 0, 0);
	...
	// 	datasets: [{
	// 		data: _binv,
	// 		backgroundColor: ['#1a9c86', '#ffbd5a', '#f74f75',]
	// 	}]
	// };
	var optionpie = {
		maintainAspectRatio: false,
