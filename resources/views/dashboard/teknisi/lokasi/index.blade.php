    ...
    <div class="row row-sm">
        <div class="col-lg-12">
            <div class="btn-group ms-2 mt-2 mb-2">
                <a class="btn btn-success" href="{{route('teknisi.tambahlokasi')}}">
                    Tambah Lokasi
                </a>
            </div>
                        ...
                        <table class="table table-bordered table-striped mg-b-0 text-md-nowrap">
                            ...
                            @foreach ($lokasis as $no => $lokasi)
                                <tr>
                                    ...
                                    <td>
                                        <a class="btn btn-warning" href="{{ route('teknisi.editlokasi', $lokasi->id_master) }}" data-toggle="tooltip" title="Edit">
