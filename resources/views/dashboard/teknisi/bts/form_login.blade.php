    ...
    <div class="col-lg-12 col-xl-12 col-md-12 col-sm-12">
        <div class="card  box-shadow-0 ">
            ...
            <div class="card-body pt-0">
                ...
                @endif
                <form method="POST" action="{{ route('teknisi.postloginbts') }}">
                    @csrf
                    <div class="form-group">
                        <label for="ip" class="form-label">IP Address</label>
                        <input class="form-control" id="ip" name="ip" placeholder="Masukkan IP Address" type="text" required autocomplete="ip" autofocus>
                    </div>
                    <div class="form-group">
