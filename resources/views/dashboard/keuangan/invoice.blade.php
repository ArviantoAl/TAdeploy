...
@section('content')
    ...
    <div class="row row-sm">
        <div class="col-lg-12">
            <form action="{{ route('keuangan.invoice') }}" method="GET">
                            ...
                            @foreach ($invoices as $no => $invoice)
                                <tr>
                                    ...
                                    @elseif($invoice->status_id == 7)
                                        ...
                                        <td>
                                            <a class="btn btn-success" href="{{ route('keuangan.approvepembayaran', $invoice->id_invoice) }}" data-toggle="tooltip" title="Setujui">
                                                <i class="fa fa-check"></i>
                                            </a>
                                            <a class="btn btn-danger" href="{{ route('keuangan.tolakpembayaran', $invoice->id_invoice) }}" data-toggle="tooltip" title="Tolak">
                                                <i class="fa fa-ban"></i>
                                            </a>
                                        </td>
                                    ...
                                    @elseif($invoice->status_id == 11)
                                        ...
                                        <td>
                                            <a class="btn btn-success" href="{{ route('keuangan.approveklaim', $invoice->id_invoice) }}" data-toggle="tooltip" title="Setujui klaim unggah ulang">
                                                <i class="fa fa-check"></i>
                                            </a>
                                        </td>
                                    @endif
                                    <td>
                                        <a class="btn btn-success" href="{{ route('keuangan.printinv', $invoice->id_invoice) }}" data-toggle="tooltip" title="Cetak">
            ...
            <div class="modal-dialog modal-xl">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="{{ route('keuangan.setujuimanual', $invoice->id_invoice) }}" method="POST">
                            @csrf
