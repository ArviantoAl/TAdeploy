...
<div class="container">
    <div class="card">
        <div class="card-header">
            ...
            <span class="float-right"> <strong>Status:</strong> Belum Dibayar</span><br>
            <span class="float-right"> <strong>Tanggal terbit:</strong> {{ $data_ambil['tgl_terbit'] }}</span><br>
            <span class="float-right"> <strong>Tanggal tempo:</strong> {{ $data_ambil['tgl_tempo'] }}</span>
